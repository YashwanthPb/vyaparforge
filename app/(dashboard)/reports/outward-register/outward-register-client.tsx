...
import { getOutwardRegister } from "../actions";
...
export function OutwardRegisterClient({
  initialData,
  divisions,
}: {
  initialData: OutwardRow[];
  divisions: Division[];
}) {
  ...
  function applyFilters() {
    startTransition(async () => {
      const result = await getOutwardRegister({
  ...
  function handleExport() {
    ...
    exportToExcel({
      ...
      columns: [
        ...
        { header: "Qty Dispatched", key: "qty", format: "number", width: 14 },
